...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('samuelkojo399@gmail.com')
    setCopied(true)
  }
  return (
    <div
      ...
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        {id === 6 && (
          <div className="mt-5 relative">
            ...
            <MagicButton title={copied ? 'Email copied' : 'Copy my email'} icon={<IoCopyOutline/>} otherClasses="bg-[#161a31]"
            handleClick={handleCopy} position="left"/>
          </div>
        )}
      </div>
    </div>
